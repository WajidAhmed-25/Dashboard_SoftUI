...
class Others extends Component {
  constructor(props) {
    ...
    this.fetchDataUrl = `${apiUrl}/api/email_response/get/except?page=`;
  ...
  fetchData(page) {
    axios
      ...
      .then((response) => {
        console.log("API response Others:", response.data.data);
          ...
          <SoftBox mb={3}>
            ...
            <Card>
              <SoftBox display="flex" justifyContent="space-between" alignItems="center" p={3}>
                <SoftTypography variant="h6">Others</SoftTypography>
              </SoftBox>
              <SoftBox>
