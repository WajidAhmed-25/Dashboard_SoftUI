...
import DesignUploader from "./edit-product/Design_Uploader.js";
...
class CompleteDetail extends Component {
  ...
  render() {
    const { open, uploadedImage, isEditing, selectedOption } = this.state;
                        ...
                        <SoftBox mb={2}>
                          ...
                          <label
                            ...
                            style={{
                              ...
                              width: "100%",
                              marginTop: "12px",
                              backgroundColor: selectedOption === "accept" ? "#08db3f" : "#00aaff",
                              color: selectedOption === "accept" ? "#fff" : "#fff",
                              textAlign: "center",
                              borderRadius: "5px",
                              cursor: "pointer",
                              userSelect: "none",
                          ...
                          {/* <SoftInput type="radio" name="2" placeholder="Accept" /> */}
                        </SoftBox>
                      </Grid>
                      <Grid item xs={12} md={3}>
                        <SoftBox mb={2}>
                          ...
                          <label
                            ...
                            style={{
                              ...
                              width: "100%",
                              marginTop: "12px",
                              backgroundColor: selectedOption === "reject" ? "#db0808" : "#00aaff",
                              color: selectedOption === "reject" ? "#fff" : "#fff",
                              textAlign: "center",
                              borderRadius: "5px",
                              cursor: "pointer",
                              userSelect: "none",
