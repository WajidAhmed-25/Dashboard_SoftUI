...
class Assigned extends Component {
  constructor(props) {
    ...
    this.fetchDataUrl = "http://localhost/react-dashboard/fetchData.php?q=Follow_Up";
  ...
  render() {
    ...
    const columns = [
      ...
      { name: "Assign To", accessor: "assign_to" },
          ...
          <SoftBox mb={3}>
            ...
            <Card>
              <SoftBox display="flex" justifyContent="space-between" alignItems="center" p={3}>
                <SoftTypography variant="h6">Assigned</SoftTypography>
              </SoftBox>
              <SoftBox
                sx={{
              ...
              >
                <Table columns={columns} rows={this.state.filteredRows} type="assign"/>
              </SoftBox>
            </Card>
            <Pagination
              count={pageCount}
